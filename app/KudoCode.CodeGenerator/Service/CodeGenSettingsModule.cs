...
namespace KudoCode.CodeGenerator.Service
{
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterInstance(
                new CodeGenSettings(Settings)
                {
                    ...
                    OutputFolder =
                        $@"{Settings.ProjectFolder}\app\KudoCode.LogicLayer.Domain\Logic\{Settings.Entity}s\Entities\",
            ...
            builder.RegisterInstance(
                new CodeGenSettings(Settings)
                {
                    ...
                    OutputFolder =
                        $@"{Settings.ProjectFolder}\app\KudoCode.LogicLayer.Domain\Logic\{Settings.Folder}\Handlers\{Settings.Request}",
            ...
            builder.RegisterInstance(
                new CodeGenSettings(Settings)
                {
                    ...
                    OutputFolder =
                        $@"{Settings.ProjectFolder}\app\KudoCode.Test.Unit\{Settings.Folder}\{Settings.Request}",
