        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (Environment.MachineName.Equals("DESKTOP-ARBABNG", StringComparison.InvariantCultureIgnoreCase))
                optionsBuilder.UseSqlServer(
                    "data source=DESKTOP-ARBABNG;Initial Catalog=mycontextX;Integrated Security=SSPI;",
                ...
                optionsBuilder.UseSqlServer(
                    "data source=DESKTOP-JQMQ508;Initial Catalog=mycontextX;Integrated Security=SSPI;");
        }
    }
}