...
namespace KudoCode.LogicLayer.Domain.Logic.PortfolioTransactionsConsolidations.Entities
{
    public class PortfolioTransactionsConsolidation : IEntity
    {
        public int Id { get; set; }
        public int PortfolioTransactionsSummaryId { get; set; }
        public PortfolioTransactionsSummary PortfolioTransactionsSummary { get; set; }
