...
namespace KudoCode.LogicLayer.Plugin.EntityAudit_.UnitTests.Repositories
{
	public class StubRepository : IRepository
	{
		...
		IRepository IRepository.Save<TEntity>(TEntity entity, string createdBy)
		{
			throw new NotImplementedException();
		}

		void IRepository.Update<TEntity>(TEntity entity, string modifiedBy)
		{
			throw new NotImplementedException();
		}
	}
