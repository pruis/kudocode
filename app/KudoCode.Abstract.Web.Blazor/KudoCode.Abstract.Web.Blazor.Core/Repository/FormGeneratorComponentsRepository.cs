...
namespace KudoCode.Abstract.Web.Blazor.Repository
{
    ...
    public class FormGeneratorComponentsRepository<TKey> : IFormGeneratorComponentsRepository
    {
        ...
        protected virtual Type GetComponent(TKey key)
        {
            ...
            if (key.ToString().Contains("VxLookup"))
                return _ComponentDict.First(a => a.Key.ToString().Contains("VxLookup")).Value;
