...
namespace KudoCode.Abstract.Web.Blazor
{
    ...
    public interface IKudoCodeGenericTable<TResponse>
    {
        public List<TResponse> Model { get; set; }
    ...
    public abstract class KudoCodePageComponent : KudoCodeComponent, IKudoCodePageComponent
    {
        ...
        public void AddMessage(string key, string message, MessageDtoType type)
        {
            Messages.Add(new MessageDto(key, message, type));
        }
